...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier color:(ColorItem *)color WithW:(CGFloat)width andH:(CGFloat)height{
    ...
    if(self){
        ...
        [self createButtonSliderWithW:width andH:height];
        [self collapseCell];
    }
    return self;
}
...
-(void) createButtonSliderWithW:(CGFloat)width andH:(CGFloat)height{
    ...
    saveButton.frame = CGRectMake(width*0.2, height*0.3, width*70/320, height*40/568);
    ...
    okButton.frame = CGRectMake(width*0.6, height*0.3, width*70/320, height*40/568);
    ...
    //red slider
    redSlider = [[UISlider alloc]initWithFrame:CGRectMake(width*0.25, height*0.08, width*0.6, height*10/568)];
    ...
    //green slider
    greenSlider = [[UISlider alloc]initWithFrame:CGRectMake(width*0.25, height*0.16, width*0.6, height*9/568)];
    ...
    //blue slider
    blueSlider = [[UISlider alloc]initWithFrame:CGRectMake(width*0.25, height*0.24, width*0.6, height*10/568)];
    ...
    //red left lable
    rLabel = [[UILabel alloc]initWithFrame:CGRectMake(width*0.05, height*0.06, width*60/320, height*30/568)];
    rLabel.text = @"Red";
    ...
    //green left lable
    gLabel = [[UILabel alloc]initWithFrame:CGRectMake(width*0.05, height*0.14, width*60/320, height*30/568)];
    gLabel.text = @"Green";
    ...
    //blue left labl3
    bLabel = [[UILabel alloc]initWithFrame:CGRectMake(width*0.05, height*0.22, width*60/320, height*30/568)];
    bLabel.text = @"Blue";
    ...
    //red value indicator
    rIndicator = [[UILabel alloc]initWithFrame:CGRectMake(width*0.87, height*0.06, width*60/320, height*30/568)];
    ...
    gIndicator = [[UILabel alloc]initWithFrame:CGRectMake(width*0.87, height*0.14, width*60/320, height*30/568)];
    ...
    bIndicator = [[UILabel alloc]initWithFrame:CGRectMake(width*0.87, height*0.22, width*60/320, height*30/568)];
