...
- (void)viewDidLoad {
    ...
    button1.frame = CGRectMake(self.view.frame.size.width*0.01, -self.view.frame.size.height*0.01, self.view.frame.size.width*0.15, self.view.frame.size.height*0.05);
    button1.titleLabel.font = [UIFont fontWithName:@"Arial Rounded MT Bold" size:11];
    ...
    button2.frame = CGRectMake(self.view.frame.size.width*0.84, -self.view.frame.size.height*0.01, self.view.frame.size.width*0.15, self.view.frame.size.height*0.05);
    button2.titleLabel.font = [UIFont fontWithName:@"Arial Rounded MT Bold" size:11];
    ...
    levelSegment.frame = CGRectMake(self.view.frame.size.width*0.17, -self.view.frame.size.height*0.01, self.view.frame.size.width*0.66, self.view.frame.size.height*0.05);
...
-(void)addView: (NSInteger) colorIdx{
    ...
    //set up the sliders
    //red slider
    UISlider *redSlider = [[UISlider alloc]initWithFrame:CGRectMake(tempView.frame.size.width*0.1, tempView.frame.size.height*0.1, tempView.frame.size.width*0.8, tempView.frame.size.height*0.2)];
    ...
    //green slider
    UISlider *greenSlider = [[UISlider alloc]initWithFrame:CGRectMake(tempView.frame.size.width*0.1, tempView.frame.size.height*0.35, tempView.frame.size.width*0.8, tempView.frame.size.height*0.2)];
    ...
    //blue slider
    UISlider *blueSlider = [[UISlider alloc]initWithFrame:CGRectMake(tempView.frame.size.width*0.1, tempView.frame.size.height*0.6, tempView.frame.size.width*0.8, tempView.frame.size.height*0.2)];
    ...
    //cancle button
    CGFloat buttonWidth = tempView.frame.size.width*0.3;
    CGFloat buttonHeight = 35.0;
    CGFloat buttonStartX = tempView.frame.size.width*0.1;
    ...
    //ok button
    CGFloat buttonStartX1 = tempView.frame.size.width*0.6;
